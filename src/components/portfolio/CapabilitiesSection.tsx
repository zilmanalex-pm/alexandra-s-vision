...
const skills = [
  { icon: ShieldCheck, label: "RBAC (Role-Based Access Control)" },
  { icon: BarChart3, label: "Data-Driven Decision Making" },
  { icon: Landmark, label: "GovTech Compliance" },
  { icon: Rocket, label: "B2B SaaS Strategy" },
];
          ...
          <div className="space-y-3">
            {languages.map((l) => (
              <motion.div
                key={l.lang}
                variants={popIn}
                className="flex items-center gap-3.5 px-5 py-3 rounded-2xl border border-accent/60 text-foreground backdrop-blur-md"
                style={{
                  ...font,
